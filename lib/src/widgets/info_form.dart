          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                ...
                DropdownMenuItem(value: 'Cuenca', child: Text('Ambato')),
                DropdownMenuItem(value: 'Cuenca', child: Text('Loja')),
                DropdownMenuItem(value: 'Cuenca', child: Text('Manta')),
                DropdownMenuItem(value: 'Cuenca', child: Text('Esmeraldas')),
                DropdownMenuItem(value: 'Cuenca', child: Text('Puyo')),
                DropdownMenuItem(value: 'Cuenca', child: Text('Santo Domingo')),
                DropdownMenuItem(value: 'Cuenca', child: Text('Porto Viejo')),
